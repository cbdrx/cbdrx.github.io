$(document).ready(function() {
  ...
  // Draws a rectangle with side length "width" and height "height" with its
  // bottom left corner at x. Colorstring specifies the fill color, which should
  ...
  function drawElementAt(x, value, colorString) {
    ...
    if (elementWidth > 10) {
      context.rect(
          x * elementWidth, canvasWidth - value * elementWidth,
          elementWidth - 1, value * elementWidth);
    } else {
      context.rect(
          x * elementWidth, canvasWidth - value * elementWidth, elementWidth,
          value * elementWidth);
    }
  ...
  function drawCell(grid, x, y, elementWidth, colorsArray) {
    drawSquareAt(
        x * elementWidth, y * elementWidth, elementWidth,
        colorsArray[grid[x][y]]);
  }
